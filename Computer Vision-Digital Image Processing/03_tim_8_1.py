...
Original file is located at
    https://colab.research.google.com/drive/1Z0fRgq_1svb75fCcsa7FFSR39zg_NjpH
...
plt.figure(figsize=(10, 4))
plt.hist(img_grayscaled.ravel(), 256, [0, 256])
...
"""Keunggulan operasi Max Pooling dari PyTorch dibandingkan yang dari Scikit-image adalah PyTorch menawarkan fleksibilitas dan kontrol lebih besar, integrasi mudah dengan deep learning, optimasi GPU untuk kinerja lebih cepat, dan diferensiasi otomatis yang penting untuk pelatihan model. Scikit-image lebih sederhana dan cocok untuk image processing dasar, sementara PyTorch ideal untuk deep learning yang kompleks.
...
"""Perbedaan antara Min Pooling dan Average Pooling terletak pada cara mereka memproses blok piksel. Min Pooling memilih nilai piksel minimum dalam setiap blok, menghasilkan gambar yang lebih gelap dan tajam, serta cocok untuk mengurangi noise atau menonjolkan tepi. Sedangkan Average Pooling menghitung rata-rata nilai piksel dalam setiap blok, menghasilkan gambar yang lebih halus dan terang, serta cocok untuk mereduksi ukuran gambar tanpa kehilangan informasi penting.

Intinya, Min Pooling mengambil nilai terendah, sedangkan Average Pooling mengambil nilai rata-rata, sehingga menghasilkan efek visual yang berbeda pada gambar.
...
img_clahe = apply_clahe_rgb(img=imread("photo1.jpeg")) # TODO: Panggil fungsi apply_clahe_rgb() dan isi parameter img="photo1.jpeg"
...
"""CLAHE unggul dalam meningkatkan kontras dan detail lokal di area gelap, menghasilkan gambar yang tampak lebih alami dan detail. Tidak seperti Max Pooling, CLAHE mempertahankan resolusi gambar dengan menyesuaikan kontras di wilayah kecil. Hal ini menjadikannya lebih cocok untuk mengungkap tekstur dan detail halus yang mungkin hilang dengan Max Pooling. CLAHE juga menghindari area terang yang terlalu terang sambil mencerahkan area gelap secara efektif, menghasilkan peningkatan yang lebih seimbang secara keseluruhan.

### Save your edited image
"""

FILE_NAME = "edited.png" # TODO: Berikan nama file` ke gambar yang sudah disempurnakan dengan CLAHE, diakhiri dengan ekstensi .png
...
- [x] Ubah kanal warna dari BGR ke RGB dengan cv2.COLOR_BGR2RGB
- [x] Ubah kanal warna dari BGR ke grayscale dengan cv2.COLOR_BGR2GRAY
- [x] Ubah kanal warna dari grayscale ke binary dengan cv2.THRESH_BINARY
- [x] Plot histogram dari gambar asli
- [x] Plot histogram dari gambar grayscale
- [x] PERTANYAAN: Apa keunggulan operasi Max Pooling dari PyTorch dibandingkan yang dari Scikit-image?
- [x] Panggil ulang block_reduce(), tetapi dengan func=np.min
- [x] Panggil ulang block_reduce().astype(int), tetapi dengan func=np.mean
- [x] PERTANYAAN: Apa perbedaan antara Min Pooling dan Average Pooling?
- [x] Panggil fungsi apply_clahe_rgb() dan isi parameter img="photo1.jpeg"
- [x] PERTANYAAN: Apa keunggulan menggunakan CLAHE (daripada Max Pooling) untuk mencerahkan gambar bernuansa gelap?
- [x] Berikan nama file` ke gambar yang sudah disempurnakan dengan CLAHE, diakhiri dengan ekstensi .png
